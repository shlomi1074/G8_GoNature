...
public class ClientToServerRequest<T> implements Serializable {
	...
	public enum Request {
		...
		COUNT_VISIT_GROUP_VISITORS,GET_REPORTS, GET_CANCELS,VIEW_MANAGER_DISCOUNT,CONFIRM_DISCOUNT,MANAGER_REPORT,ADD_REPORT_TO_DB,
		INSERT_TO_FULL_PARK_DATE, CHECK_WAITING_LIST
