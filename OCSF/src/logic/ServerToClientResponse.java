...
public class ServerToClientResponse<T> implements Serializable {
	...
	public enum Response {
		...
		COUNT_VISIT_SUBS_VISITORS_RESPONSE, COUNT_VISIT_GROUP_VISITORS_RESPONSE, GET_REPORTS_RESPONSE,
		GET_CANCELS_RESPONSE, VIEW_MANAGER_DISCOUNT_RESPONSE, CONFIRM_DISCOUNT_RESPONSE, MANAGER_REPORT_RESPONSE,
		ADD_REPORT_TO_DB_RESPONSE, INSERT_TO_FULL_PARK_DATE_RESPONSE, GET_SIMULATOR_TRAVELERS_IDS_RESPONSE,
		GET_RELEVANT_ORDER_ENTRANCE_RESPONSE, GET_RELEVANT_ORDER_EXIT_RESPONSE, UPDATE_EXIT_TIME_SIMULATOR_RESPONSE,
		GET_PENDING_AFTER_DATE_PASSED_RESPONSE, CHANGE_PARK_PARAMETERS_RESPONSE,
		CHANGE_ORDER_NUMBER_OF_VISITORS_BY_ID_RESPONSE, CHANGE_ORDER_PRICE_BY_ID_RESPONSE
