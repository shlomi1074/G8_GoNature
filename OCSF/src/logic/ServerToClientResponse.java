...
public class ServerToClientResponse<T> implements Serializable {
	...
	public enum Response {
		...
		GET_ALL_ORDERS_FOR_PARK_WITH_TRAVLER_RESPONSE, CONFIRM_REQUEST_RESPONSE, CHECK_IF_PARK_FULL_AT_DATE_RESPONSE,
		DELETE_REPORT_RESPONSE, INSERT_REPORT_RESPONSE, COUNT_ENTER_SOLO_VISITORS_RESPONSE,
		COUNT_ENTER_SUBS_VISITORS_RESPONSE, COUNT_ENTER_GROUP_VISITORS_RESPONSE, COUNT_VISIT_SOLO_VISITORS_RESPONSE,
		COUNT_VISIT_SUBS_VISITORS_RESPONSE, COUNT_VISIT_GROUP_VISITORS_RESPONSE,GET_REPORTS_RESPONSE, GET_CANCELS_RESPONSE,VIEW_MANAGER_DISCOUNT_RESPONSE,CONFIRM_DISCOUNT_RESPONSE,
		MANAGER_REPORT_RESPONSE,ADD_REPORT_TO_DB_RESPONSE,INSERT_TO_FULL_PARK_DATE_RESPONSE
